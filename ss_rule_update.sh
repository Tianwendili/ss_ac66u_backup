...
curl -o /tmp/version1 https://raw.githubusercontent.com/hq450/fancyss/master/rules/version1
if [ "$?" == "0" ]; then
...
if [ "$ss_basic_gfwlist_update" == "1" ];then
	if [ ! -z "$version_gfwlist2" ];then
		if [ "$version_gfwlist1" != "$version_gfwlist2" ];then
			...
			curl -o /tmp/gfwlist.conf https://raw.githubusercontent.com/hq450/fancyss/master/rules/gfwlist.conf
...
if [ "$ss_basic_chnroute_update" == "1" ];then
	if [ ! -z "$version_chnroute2" ];then
		if [ "$version_chnroute1" != "$version_chnroute2" ];then
			...
			curl -o /tmp/chnroute.txt https://raw.githubusercontent.com/hq450/fancyss/master/rules/chnroute.txt
...
if [ "$ss_basic_cdn_update" == "1" ];then		
	if [ ! -z "$version_cdn2" ];then		
		if [ "$version_cdn1" != "$version_cdn2" ];then		
			...
			curl -o /tmp/cdn.txt https://raw.githubusercontent.com/hq450/fancyss/master/rules/cdn.txt		
